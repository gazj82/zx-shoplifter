...
710 FOR i=9 TO 1 STEP -1:IF i/2-INT(i/2)<>0 THEN GO TO 730
...
735     FOR j=1 TO 50:NEXT j:NEXT i
...
753 FOR j=1 TO 5
755 PRINT AT 14,0;"NAI!":PRINT AT 15,0;"{B}{D}{G}":PRINT AT 16,0;" {INVERSE1}K{INVERSE0} ":PRINT AT 17,0;"( )":FOR i=1 TO 50:NEXT i
760 PRINT AT 14,0;"NAI!":PRINT AT 15,0;"({D})":PRINT AT 16,0;" {INVERSE1}K{INVERSE0} ":PRINT AT 17,0;"{H} {E}":FOR i=1 TO 50:NEXT i:NEXT j
770 GO SUB 900
780 PRINT AT 14,0;"    "
782 PRINT AT 15,0;" {INVERSE1}${INVERSE0}{D})":PRINT AT 16,0;"{L}{INVERSE1}K{INVERSE0}":PRINT AT 17,0;"{H} "
